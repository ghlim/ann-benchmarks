...
namespace hnnglib {
    ...
    public:
        ...
        // dist_func returns squared L2; the true metric is sqrt.
        float to_metric(float d) override { return std::sqrt(d); }
    ...
    public:
        ...
        // dist_func returns squared L2; true metric is sqrt (integer-cast).
        int to_metric(int d) override { return static_cast<int>(std::sqrt(double(d))); }
